...
#Empty rows to show the facets in the final figure if the TE is missing, this extra lines will be removed in the .svg
mock_df <- data.frame(
  rm = c("rm", "rm", "rm", "rm"),
  ...
  fragtype = c("diverged", "diverged", "diverged", "diverged")
)
