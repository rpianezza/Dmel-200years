---
title: "Full history of D. mel TEs in the last two centuries from long-read assemblies "
...
Empty rows to show the facets in the final figure if the TE is missing (like in Canton-S), this extra lines will be removed in the .svg
```{r}
mock_df <- data.frame(
  rm = c("rm", "rm", "rm", "rm"),
